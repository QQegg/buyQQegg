...
<div class="gallery" xmlns:v-bind="http://www.w3.org/1999/xhtml">
		<div class="container">
			...
			@foreach($store as $store)
				...
				@else
					<button class="btn btn-info" data-toggle="modal" data-target="#editComment">編輯評論</button>
				@endif
						...
						<form action="{{route('comstore',Auth::user()->id)}}" method="POST" id="frm-insert">
							...
							<div class="modal-body">
								...
								<div class="write-review-comment-container">
									<textarea id="accept" name="content" style="resize:none; width:566px;height:100px;" class="review-input-text-box write-review-comment" maxlength=" 4096 " placeholder="請寫下對本店的評論" aria-label="請寫下對本店的評論"></textarea>
								</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<form action="{{route('comstore',Auth::user()->id)}}" method="POST" id="frm-insert">
						...
						<div class="modal-body">
							<input type="hidden" name="Store_id" value="{{$store->id}}">
							@foreach($user_comment as $user_comment)
							<div class="write-review-comment-container">
								<textarea id="accept2" name="content" style="resize:none; width:566px;height:100px;" class="review-input-text-box write-review-comment" maxlength=" 4096 " placeholder="請寫下對本店的評論" aria-label="請寫下對本店的評論">{{$user_comment->content}}</textarea>
							</div>
							@endforeach
							<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
							<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
						...
						<div class="modal-footer">
							...
							<button type="submit" class="btn btn-success pull-right" disabled="disabled">提交</button>
							<button type="button" class="btn btn-default pull-left" data-dismiss="modal">close</button>
						</div>
					</form>
				</div>
