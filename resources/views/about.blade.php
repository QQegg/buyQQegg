		...
		<div class="container">
			...
			<div class="about-grids">
				<div class="col-md-6 about-grid">
					...
					<h4>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet aliquid ex ea consectetur</h4>
		...
		<div class="container">
			...
			<div class="events-grids">
				<div class="col-md-4 events-grid">
					<div class="mnth-date">
						<div class="col-xs-5 mnth-date-left">
							<h4>15 th<span>September</span></h4>
						</div>
				...
				<div class="col-md-4 events-grid">
					<div class="mnth-date">
						<div class="col-xs-5 mnth-date-left">
							<h4>18 th<span>September</span></h4>
						</div>
						<div class="col-xs-7 mnth-date-right">
							<p>Lorem ipsum dolor sit amet aperiam.</p>
						</div>
				...
				<div class="col-md-4 events-grid">
					<div class="mnth-date">
						<div class="col-xs-5 mnth-date-left">
							<h4>30 th<span>September</span></h4>
						</div>
						<div class="col-xs-7 mnth-date-right">
							<p>Lorem ipsum dolor sit amet aperiam.</p>
						</div>
		...
		<div class="container">
			<div class="footer-row">
				<div class="col-md-3 footer-grids">
					<h4><a href="index.html">Seafaring</a></h4>
